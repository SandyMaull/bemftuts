...
<body id="page-top">
  ...
  <script src="{{asset('admintemplate/vendor/datatables/jquery.dataTables.js')}}"></script>
  <script src="{{asset('admintemplate/vendor/datatables/dataTables.bootstrap4.js')}}"></script>
