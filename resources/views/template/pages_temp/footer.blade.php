...
<footer>
    <div class="container-fluid padding">
        <div class="row text-center">
            <div class="col-md-4">
                <img src="{{ asset('assets/img/bem.png') }}" style="height:50px;"> <span style="margin-left:1.5rem;font-size:1.3em;">BEM FT UTS</span>
                <hr class="light">
                <p>0822 6087 9023</p>
                <p><a href="mailto:admin@bemftuts.ac.id">admin@bemftuts.ac.id</a></p>
            ...
            <div class="col-12">
                <hr class="light-100">
                <h5>&copy: Badan Eksekutif Mahasiswa Fakultas Teknik Universitas Teknologi Sumbawa</h5>
            </div>
        </div>
    </div>
</footer>